...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dj2GLhPY.mjs");
...
const manifest = {
  "99de2d9a4a035cd84ff66b062232a94fa841bee0f8ef394e703582f7fe8047ae": {
    functionName: "analyzeUser_createServerFn_handler",
    importer: () => import("./github.functions-Dsh0WoK3.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cw8m5JH4.mjs").then((n) => n.r),
    import("./start-Es32luN0.mjs"),
